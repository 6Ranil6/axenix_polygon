...
## Для старта
    ...
    Чтобы использовать LoRA-адаптер, скачайте zip архив с яндекс диска и распакуйте его в корень проекта.

Ссылка на Яндекс Диск: [DISK](https://disk.yandex.ru/d/TnQQsI7rJ8d3Zw)
